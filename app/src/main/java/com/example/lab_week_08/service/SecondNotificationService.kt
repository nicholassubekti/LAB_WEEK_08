...
class SecondNotificationService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        serviceHandler.post {
            ...
            //Here, we're counting down from 15 to 0 in the notification (changed to avoid collision)
    ...
    //A function to update the notification to display a count down from 15 to 0
    private fun countDownFromFifteenToZero(notificationBuilder: NotificationCompat.Builder) {
